...
(select 'T_DQYZGZP','电气一种工作票',DATE_FORMAT(S_GZZJ_GZXKRQMSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_DQYZGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_GZZJ_GZXKRQMSJ<>'') gzp
...
(select 'T_DQEZGZP','电气二种工作票',DATE_FORMAT(S_GZZJ_XKRQMSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_DQEZGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_GZZJ_XKRQMSJ<>'') gzp
...
(select 'T_RLYZGZP','热力机械工作票',DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2)+sum(aqcsCount3) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_RLYZGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_GZZJ_XKRQZSJ<>'') gzp
...
(select 'T_YJDHGZP','一级动火工作票',DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_YJDHGZP.S_WXZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_GZZJ_XKRQZSJ<>'') gzp
LEFT OUTER JOIN (select s_fid,count(*) aqcsCount from t_dhy_aqcs GROUP BY s_fid) aqcs on aqcs.s_fid=gzp.S_ID
group by DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d'),S_USER_CODE, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))

UNION All

(select 'T_EJDHGZP','二级动火工作票',DATE_FORMAT(S_ZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_EJDHGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_ZJ_XKRQZSJ<>'') gzp
...
(select 'T_RKGZP','热控工作票',DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDJ bpdd, if(S_BPDJ='01_JK', S_ZJ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_RKGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_GZZJ_XKRQZSJ<>'') gzp
...
(select 'T_YJQXGZP','应急抢修工作票',DATE_FORMAT(S_GZZJ_GZXKRSPSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_YJQXGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_GZZJ_GZXKRSPSJ<>'') gzp
...
(select 'T_DTGZP','动土工作票',DATE_FORMAT(S_XKRQZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount) count
...
where S_DEL<>'1' and S_GZPZT<>'GZPZT051' and T_DTGZP.S_ZZ='001017' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XKRQZSJ<>'') gzp

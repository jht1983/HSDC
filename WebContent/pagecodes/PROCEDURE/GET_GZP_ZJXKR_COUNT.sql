...
(select 'T_DQYZGZP','电气一种工作票',DATE_FORMAT(S_GZZJ_GZXKRQMSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0))+sum(IFNULL(aqcsCount2,0)) count
...
group by DATE_FORMAT(S_GZZJ_GZXKRQMSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))

UNION All

(select 'T_DQEZGZP','电气二种工作票',DATE_FORMAT(S_GZZJ_XKRQMSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0))+sum(IFNULL(aqcsCount2,0)) count
...
group by DATE_FORMAT(S_GZZJ_XKRQMSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))

UNION All

(select 'T_RLYZGZP','热力机械工作票',DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0))+sum(IFNULL(aqcsCount2,0))+sum(IFNULL(aqcsCount3,0)) count
...
group by DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))

UNION All

(select 'T_YJDHGZP','一级动火工作票',DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0)) count
...
(select 'T_EJDHGZP','二级动火工作票',DATE_FORMAT(S_ZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0)) count
...
group by DATE_FORMAT(S_ZJ_XKRQZSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))

UNION All

(select 'T_RKGZP','热控工作票',DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDJ bpdd, if(S_BPDJ='01_JK', S_ZJ,'') jz, sum(IFNULL(aqcsCount,0))+sum(IFNULL(aqcsCount2,0)) count
...
group by DATE_FORMAT(S_GZZJ_XKRQZSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDJ, if(S_BPDJ='01_JK', S_ZJ,''))

UNION All

(select 'T_YJQXGZP','应急抢修工作票',DATE_FORMAT(S_GZZJ_GZXKRSPSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0))+sum(IFNULL(aqcsCount2,0)) count
...
group by DATE_FORMAT(S_GZZJ_GZXKRSPSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))

UNION All

(select 'T_DTGZP','动土工作票',DATE_FORMAT(S_XKRQZSJ,'%Y-%m-%d') xksj,S_GZZJ_BZBM bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(IFNULL(aqcsCount,0)) count
...
group by DATE_FORMAT(S_XKRQZSJ,'%Y-%m-%d'),S_GZZJ_BZBM, S_BPDD, if(S_BPDD='01_JK', S_JZ,''));

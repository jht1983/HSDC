...
from T_DQYZGZP LEFT OUTER JOIN T_BZRYB on T_DQYZGZP.S_GZXKRQM=T_BZRYB.S_PEOPLE_CODE and T_DQYZGZP.S_JZ=T_BZRYB.S_JZ_ATTR
...
from T_DQEZGZP LEFT OUTER JOIN T_BZRYB on T_DQEZGZP.S_XKGZXKRQMBM=T_BZRYB.S_PEOPLE_CODE and T_DQEZGZP.S_JZ=T_BZRYB.S_JZ_ATTR
...
from T_RLYZGZP LEFT OUTER JOIN T_BZRYB on T_RLYZGZP.S_XKGZXKRBM=T_BZRYB.S_PEOPLE_CODE and T_RLYZGZP.S_JZ=T_BZRYB.S_JZ_ATTR
...
from T_JBGZP LEFT OUTER JOIN T_BZRYB on T_JBGZP.S_XK_GZXKRBM=T_BZRYB.S_PEOPLE_CODE and T_JBGZP.S_JZ=T_BZRYB.S_JZ_ATTR
...
from T_YJDHGZP LEFT OUTER JOIN T_BZRYB on T_YJDHGZP.S_XKYXBM=T_BZRYB.S_PEOPLE_CODE and T_YJDHGZP.S_JZ=T_BZRYB.S_JZ_ATTR
...
(select DATE_FORMAT(S_XK_YXXKDHSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, count(S_USER_CODE) count
from T_EJDHGZP LEFT OUTER JOIN T_BZRYB on T_EJDHGZP.S_XK_YXXKRBM=T_BZRYB.S_PEOPLE_CODE and T_EJDHGZP.S_JZ=T_BZRYB.S_JZ_ATTR
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_YXXKDHSJ<>''
group by DATE_FORMAT(S_XK_YXXKDHSJ,'%Y-%m-%d'),S_USER_CODE, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))
...
from T_RKGZP LEFT OUTER JOIN T_BZRYB on T_RKGZP.S_GZXKRBM=T_BZRYB.S_PEOPLE_CODE and T_RKGZP.S_ZJ=T_BZRYB.S_JZ_ATTR
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_XKRSJ<>''
...
from T_YJQXGZP LEFT OUTER JOIN T_BZRYB on T_YJQXGZP.S_XK_GZXKRQZBM=T_BZRYB.S_PEOPLE_CODE and T_YJQXGZP.S_JZ=T_BZRYB.S_JZ_ATTR
...
(select DATE_FORMAT(S_PZKSGZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, count(S_USER_CODE) count
from T_DTGZP LEFT OUTER JOIN T_BZRYB on T_DTGZP.S_DTXKRBM=T_BZRYB.S_PEOPLE_CODE and T_DTGZP.S_JZ=T_BZRYB.S_JZ_ATTR
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_PZKSGZSJ<>''
group by DATE_FORMAT(S_PZKSGZSJ,'%Y-%m-%d'),S_USER_CODE, S_BPDD, if(S_BPDD='01_JK', S_JZ,''))
) gzp

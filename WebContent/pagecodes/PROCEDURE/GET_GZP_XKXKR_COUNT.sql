...
(
(select DATE_FORMAT(S_XKKSGZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XKKSGZSJ<>'') gzp
...
(select DATE_FORMAT(S_XK_XKRQZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
from (select DISTINCT T_DQEZGZP.*,S_USER_CODE from T_DQEZGZP LEFT OUTER JOIN T_BZRYB on T_DQEZGZP.S_XKGZXKRQMBM=T_BZRYB.S_PEOPLE_CODE
 where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_XKRQZSJ<>'') gzp
...
(select DATE_FORMAT(S_XK_XKRSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2)+sum(aqcsCount3) count
...
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_XKRSJ<>'') gzp
...
(select DATE_FORMAT(S_XK_XKKSGZSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount) count
...
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_XKKSGZSJ<>'') gzp
...
(select DATE_FORMAT(S_XK_YXXKDHSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount) count
...
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_YXXKDHSJ<>'') gzp
...
(select DATE_FORMAT(S_XK_XKRSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDJ bpdd, if(S_BPDJ='01_JK', S_ZJ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
(select DATE_FORMAT(S_XK_GZXKRSPSJ,'%Y-%m-%d') xksj,S_USER_CODE bz, S_BPDD bpdd, if(S_BPDD='01_JK', S_JZ,'') jz, sum(aqcsCount)+sum(aqcsCount2) count
...
where S_DEL<>'1' and S_USER_CODE in ('01', '02', 'hd03', '21') and S_XK_GZXKRSPSJ<>'') gzp

...
public final class FunDao {
	 ...
	 * @return
	 */
	public static boolean exportWorkTicketEFirst(String sid) {
		boolean success = true;
		DBFactory dbf = new DBFactory();
		
		try {
			String uuid = EString.generId();
			dbf.sqlExe("INSERT INTO t_dqyzgzp_dx(S_ID,S_GZDDGZSB,S_GZNR,D_CREATETIME)(SELECT '" + uuid + "',S_GZDDGZSB,S_GZNR,NOW() FROM t_dqyzgzp where s_id='" + sid + "')", false);
	 ...
	 * @return
	 */
	public static boolean exportWorkTicketESecond(String sid) {
		boolean success = true;
		DBFactory dbf = new DBFactory();
		
		try {
			String uuid = EString.generId();
			dbf.sqlExe("INSERT INTO t_dqezgzp_dx(S_ID,S_GZDD,S_GZNR,D_CREATETIME)(SELECT '" + uuid + "',S_GZDD,S_GZNR,NOW() FROM t_dqezgzp where s_id='" + sid + "')", false);
	 ...
	 * @return
	 */
	public static boolean exportWorkTicketMachine(String sid) {
		boolean success = true;
		DBFactory dbf = new DBFactory();
		
		try {
			String uuid = EString.generId();
			dbf.sqlExe("INSERT INTO T_RLYZGZP_dx(S_ID,S_GZDD,S_GZNR,D_CREATETIME)(SELECT '" + uuid + "',S_GZDD,S_GZNR,NOW() FROM T_RLYZGZP where s_id='" + sid + "')", false);
	 ...
	 * @return
	 */
	public static boolean exportWorkTicketThermalControl(String sid) {
		boolean success = true;
		DBFactory dbf = new DBFactory();
		
		try {
			String uuid = EString.generId();
			dbf.sqlExe("INSERT INTO T_RKGZP_dx(S_ID,S_GZDD,S_GZNR,D_CREATETIME)(SELECT '" + uuid + "',S_GZDD,S_GZNR,NOW() FROM T_RKGZP where s_id='" + sid + "')", false);

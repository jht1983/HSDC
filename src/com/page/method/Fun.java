...
public class Fun {
	...
	public StringBuffer TheGateway() {
		StringBuffer localStringBuffer = new StringBuffer();
		localStringBuffer.append(
				"<table id='flowgate' width='100%' class='table1'><col width='30%'/><col width='10%'/><col /><tr><th class='td1'>鑺傜偣鍚嶇О </th><th class='td1'>榛樿 </th><th class='td1'>鏉′欢璁剧疆 | 鏄惁鎵嬪姩閫夋嫨鑺傜偣<input id='SFSDXZJD' type='checkbox' style='vertical-align: middle;' onclick='morenxuanze(this)' /> </th></tr");

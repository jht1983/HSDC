    ...
    public boolean ratHazard(String _planPk) {
	    ...
	    DBFactory dbf = new DBFactory();
	     ...
	     try{
	         ...
	         dbf.sqlExe("insert into T_YHZL (S_ID,S_ZZ,SYS_FLOW_VER,S_RUN_ID,S_YHMC,T_YHXZ,T_YHCSDYY,S_YHDJ,S_YHPGSJ,S_YHLB,T_YHWHCD,S_QXBH,S_QXZT,S_JZ,S_QXLB,S_SBMC,S_SBBM,S_SSZY,S_XQDW,S_FXR,S_FXRBM,S_FXSJ,S_FXRSSBM_NAME,S_FXRSSBM,S_FXRSSBZ,S_GZPPZ,S_GZXXSM,S_GZFZR,S_GZFZRBM,S_QXYY,S_YHFXR,S_YHFXRBM,S_YHFXRSSBM_NAME,S_YHFXRSSBM,S_GSZNBM,S_PGFZR,S_PGFZRBM,S_PGSJ,S_PGLD,S_PGLDBM,S_PGLDSJ,S_PG_PGDJ,S_PG_PGFZR,S_PG_PGFZRBM,S_PG_PGSJ,S_PG_PGLD,S_PG_PGLDBM,S_PG_PGLDSJ) select '" + 
	    	            timeStamp + "',S_ZZ,'" + mu.getFlowVer("1516606174518",T_YHDJPG__S_ZZ) + "','" + mu.getShortUuid() + 
	    	            "' ,S_YHMC,T_YHXZ,T_YHCSDYY,S_YHDJ,S_DJRQ,S_YHLB,S_YHWHCD,S_QXBH,S_QXZT,S_JZ,S_QXLB,S_SBMC,S_SBBM,S_SSZY,S_XQDW,S_FXR,S_FXRBM,S_FXSJ,S_FXRSSBM_NAME,S_FXRSSBM,S_FXRSSBZ,S_GZPPZ,S_GZXXSM,S_GZFZR,S_GZFZRBM,S_QXYY,S_YHFXR,S_YHFXRBM,S_YHFXRSSBM_NAME,S_YHFXRSSBM,S_GSZNBM,S_PGFZR,S_PGFZRBM,S_PGSJ,S_PGLD,S_PGLDBM,S_PGLDSJ,S_PG_PGDJ,S_PG_PGFZR,S_PG_PGFZRBM,S_PG_PGSJ,S_PG_PGLD,S_PG_PGLDBM,S_PG_PGLDSJ from T_YHDJPG where S_ID = '" + _planPk + "'", false);
